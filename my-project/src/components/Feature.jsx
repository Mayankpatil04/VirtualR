        ...
        <div className='relative mt-20 border-b border-neutral-800 min-h-[800px]'>
            <div className="text-center">
                ...
                >Easily build
                    ...
                    <span className='bg-gradient-to-r from-orange-500 to bg-orange-800 text-transparent bg-clip-text'>{" "}your code</span>
                </h2>

                <div className='flex flex-wrap mt-10 lg:px-30 lg:mt-20 '>

                    {features.map((features, index) => (<div key={index} className='w-full sm:w-1/2 lg:w-1/3 '>
                        <div className='flex'>
                         ...
                         <div>
                            <h5 className='mt-1 mb-4 text-xl'>{features.text}</h5>
